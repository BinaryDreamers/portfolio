const memberData = [
  {
    ...
    title: "Abraham Masresha",
    description: "UI Developer",
    tag: "Business",
    date: "2024-08-07",
    buttonLabel: "See More",
    link1: "https://github.com/theblackethiopiandude/SWIFT-SALES",
    link2: "https://github.com/theblackethiopiandude/SWIFT-SALES",
    link3: "https://github.com/theblackethiopiandude/SWIFT-SALES",
  },
  {
    imageUrl: "assets/images/SWIFT-image.png",
    title: "Abraham Masresha",
  ...
  memberData.forEach((data, index) => {
    ...
    memberCard.innerHTML = `
        <div class="memberCard">
                ...
                <h2 class="memberHeadline">${data.title}</h2>
                <p class="memberDescription">${data.description}</p>
                <div class="memberSocial">
                    <a href="${data.link1}"><span class="memberIcon">Icon</span></a>
                    <a href="${data.link2}"><span class="memberIcon">Icon</span></a>
                    <a href="${data.link3}"><span class="memberIcon">Icon</span></a>
                </div>
                <button class="memberCardButton"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
